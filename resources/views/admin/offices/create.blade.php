...
<div class="max-w-4xl mx-auto my-8 bg-white rounded-lg shadow-md overflow-hidden">
    ...
    <div class="bg-blue-600 px-6 py-4">
        <div class="flex items-center justify-between">
            <h2 class="text-2xl font-bold text-white">Register New School Office</h2>
            <a href="{{ route('dashboard') }}" class="text-blue-100 hover:text-white flex items-center">
        ...
        <p class="text-blue-100 mt-1">Complete the form to register a new administrative office</p>
    </div>
    ...
    <!-- Form Content -->
    <form action="{{ route('admin.offices.store') }}" method="POST" enctype="multipart/form-data" class="p-2 space-y-2">
        @csrf
        ...
        <div class="border-b border-gray-200 pb-6">
            ...
            <div class="mt-4  grid-cols-1 gap-y-0 gap-x-4 ">
                <!-- Office Name -->
