...
@section('content')
    <div class="py-8 px-4 text-center bg-gradient-to-r from-blue-50 to-gray-50 rounded-lg mx-4 sm:mx-0">
        <h2 class="text-3xl font-bold text-gray-800 mb-2">Office Management</h2>
        <p class="text-gray-600 max-w-2xl mx-auto">Manage all office locations, photos, and details in one place</p>
    </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h3 class="text-xl font-semibold text-gray-800">Office Directory</h3>
                        <div class="flex flex-wrap gap-4 mt-2">
                            <div class="flex items-center">
                                <span class="bg-blue-100 text-blue-800 p-2 rounded-full mr-2">
                                ...
                                <div>
                                    <p class="text-xs text-gray-500">Total Offices</p>
                                    <p class="font-semibold">{{ $offices->count() }}</p>
                                </div>
                            </div>
                            <div class="flex items-center">
                                <span class="bg-green-100 text-green-800 p-2 rounded-full mr-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold">{{ $offices->sum(fn($office) => $office->photos->count()) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            Close
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            <a href="{{ route('admin.offices.edit', $office->id) }}" class="text-blue-600 hover:text-blue-900 p-1 rounded-md hover:bg-blue-50" title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                                        <div class="flex flex-col items-center justify-center py-8">
                                            ...
                                            <div class="mt-6">
                                                <a href="/admin/offices/create" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700">
                                    Showing
                                    <span class="font-medium">{{ $offices->firstItem() }}</span>
                                    to
                                    <span class="font-medium">{{ $offices->lastItem() }}</span>
                                    of
                                    <span class="font-medium">{{ $offices->total() }}</span>
                                    results
                                </p>
                            </div>
                            <div>
